...
for line in mpfr8_file.readlines()[1:]:
  step_data_8 = line.split(',', 5)
  t_8.append(np.float64(step_data_8[0]))
  x1_8.append(np.float64(step_data_8[1]))
  y1_8.append(np.float64(step_data_8[2]))
  x2_8.append(np.float64(step_data_8[3]))
  y2_8.append(np.float64(step_data_8[4]))
  NSTEPS+=1

for line in mpfr16_file.readlines()[1:]:
  step_data_16 = line.split(',', 5)
  t_16.append(np.float64(step_data_16[0]))
  x1_16.append(np.float64(step_data_16[1]))
  y1_16.append(np.float64(step_data_16[2]))
  x2_16.append(np.float64(step_data_16[3]))
  y2_16.append(np.float64(step_data_16[4]))

for line in mpfr32_file.readlines()[1:]:
  step_data_32 = line.split(',', 5)
  t_32.append(np.float64(step_data_32[0]))
  x1_32.append(np.float64(step_data_32[1]))
  y1_32.append(np.float64(step_data_32[2]))
  x2_32.append(np.float64(step_data_32[3]))
  y2_32.append(np.float64(step_data_32[4]))

for line in mpfr64_file.readlines()[1:]:
...
for line in mpfr128_file.readlines()[1:]:
