#import from mpfr_data file in project
ic10_pol11 <- read.csv(file="~/CS499/CS499/mpfr_data/ic_10/polar11.csv")
ic10_pol24 <- read.csv(file="~/CS499/CS499/mpfr_data/ic_10/polar24.csv")
ic10_pol53 <- read.csv(file="~/CS499/CS499/mpfr_data/ic_10/polar53.csv")
ic10_pol64 <- read.csv(file="~/CS499/CS499/mpfr_data/ic_10/polar64.csv")
ic10_pol113 <- read.csv(file="~/CS499/CS499/mpfr_data/ic_10/polar113.csv")
